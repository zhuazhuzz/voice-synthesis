...
with gr.Blocks(title="GPT-SoVITS WebUI") as app:
    ...
    with gr.Group():
        ...
        with gr.Row():
            ...
            inp_ref = gr.Audio(
                value="GPT_SoVITS/file/audio/jp/5003_jp.ogg_0000000000_0000129920.wav",
                label="Reference Audio (Cannot be changed)", # "参考音频 (不可更改)" =========================================================================
                interactive=False,
                type="filepath",
                scale=13
            )
            with gr.Column(scale=13):
                ...
                # transcription AREA ==============================================================
                prompt_text = gr.Textbox(label=i18n("参考音频的文本"), value="将軍様が伝授した刀の鍛造技法は", lines=5, max_lines=5, scale=1)
            with gr.Column(scale=14):
                prompt_language = gr.Dropdown(
                    label=i18n("参考音频的语种"), # Language for REFERENCE AUDIO ========================================================
        ...
        with gr.Row():
            ...
            with gr.Column(scale=7):
                text_language = gr.Dropdown(
                    ...
                    choices=list(dict_language.keys()),
                    value=i18n("日文"), # INFERENCE JP text language ====================================================================================================
                    scale=1,
                )
